...
const ru: NativeConfig = {
  ...
  transcriptionInstruction:
    "кириллицей — как оно реально произносится вслух носителем языка (учитывая оглушение/озвончение согласных, ударение и другие фонетические изменения — а НЕ побуквенное чтение написания), обычными русскими буквами, без специальных фонетических символов; ударный слог выдели заглавными буквами",
...
const en: NativeConfig = {
  ...
  adjN: "английское",
  transcriptionInstruction:
    'латиницей, английской фонетической транслитерацией (readable respelling, например "boo-KOO") — как слово реально звучит вслух у носителя языка (учитывая оглушение/озвончение согласных и другие фонетические изменения, а НЕ побуквенное чтение написания), без специальных символов IPA; ударный слог выдели ЗАГЛАВНЫМИ буквами',
  glossExample: "tired",
};
